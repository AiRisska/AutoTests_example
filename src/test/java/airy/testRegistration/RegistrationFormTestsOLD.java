...
import airy.pagesOLD.CheckingRegPage;
import airy.pagesOLD.ClickOnKey;
import airy.pagesOLD.OpenPages;
import airy.pagesOLD.RegistrationPage;
...
@Tag("regForm")
public class RegistrationFormTestsOLD extends TestBase {
